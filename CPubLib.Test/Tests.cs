...
namespace CPubLib.Test
{
    public class Tests
    {
        ...
        private static IReadOnlyList<PageDescription> TestItems { get; } = Enumerable.Range(0, 3).Select((d, e) => new PageDescription($"ItemId{d}", $"ItemId{d}.xhtml", $"ItemId{d}NavLabel", null, null)).ToArray();
